...
class DataIngestion:
    ...
    def download_housing_data(self,):
        try:
            ...
            #folder location to dowmload file
    ...
    def extract_tgz_file(self,tgz_file_path)->str:
        try:
            ...
            logging.info(f"Extracting file [{tgz_file_path}] into directory [{raw_data_dir}]")
    ...
    def split_data_as_train_test(self,)-> DataIngestionArtifact:
        try:
            ...
            housing_data_frame["income_cat"]=pd.cut(housing_data_frame["median_income"],bins=[0.0,1.5,3.0,4.5,6.0,np.inf],labels=[1,2,3,4,5,6])
